...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    OP_AND = 281,                  /* OP_AND  */
    OP_NOT = 282,                  /* OP_NOT  */
    OP_EQUAL = 283,                /* OP_EQUAL  */
    OP_RELATIVE = 284,             /* OP_RELATIVE  */
    OPEN_PAREN = 285,              /* OPEN_PAREN  */
    CLOSE_PAREN = 286,             /* CLOSE_PAREN  */
    OPEN_BRACK = 287,              /* OPEN_BRACK  */
    CLOSE_BRACK = 288,             /* CLOSE_BRACK  */
    OPEN_BRACE = 289,              /* OPEN_BRACE  */
    CLOSE_BRACE = 290,             /* CLOSE_BRACE  */
    FINISH_LINECODE = 291,         /* FINISH_LINECODE  */
    SINGLE_DOT = 292,              /* SINGLE_DOT  */
    SINGLE_COMMA = 293,            /* SINGLE_COMMA  */
    ASSIGN_VALUE = 294,            /* ASSIGN_VALUE  */
    REFER_VALUE = 295,             /* REFER_VALUE  */
    IDENTIFIER = 296,              /* IDENTIFIER  */
    INT_CONST = 297,               /* INT_CONST  */
    FLT_CONST = 298,               /* FLT_CONST  */
    CHR_CONST = 299,               /* CHR_CONST  */
    STR_L = 300,                   /* STR_L  */
    CLASS_NAME = 301               /* CLASS_NAME  */
  };
